<template>
    <view class="login-container" v-if="showLoginForm">
        <view class="login-form">
            <view class="form-title">绑定金环账号</view>
            <view class="input-group">
                <input type="tel" v-model="formData.phone" placeholder="请输入手机号" maxlength="11" class="input-field" />
            </view>
            <view class="input-group">
                <input type="password" password v-model="formData.password" placeholder="请输入密码" class="input-field" />
            </view>
